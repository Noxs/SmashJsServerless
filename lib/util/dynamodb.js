...
class Dynamodb {
    constructor(configuration) {
        ...
        this._table = this._sanityCheck(configuration.table, "table", "string", "configuration"); //FULL NAME
        // this.suffix = this._sanityCheck(configuration.suffix, "suffix", "string", "configuration");
        this.name = this._sanityCheck(configuration.name, "name", "string", "configuration");
        this.name = this._toCamelCase(this.name);
    ...
    get table() {
        if (this.suffix) {
            return this._table + UNDERSCORE + this.suffix;
        } else {
            return this._table;
        }
    }
