...
class BadRequest extends SmashError {
    ...
    printError() {
        this.logger.info("Code: " + this.code + ", reason: " + this.getMessageToPrint(), "Details: " + this.details ? JSON.stringify(this.details) : "No details provided");
        return this;
    }
}
...
class InternalServerError extends SmashError {
    printError() {
        this.logger.error("Code: " + this.code + ", reason: " + this.getMessageToPrint());
        if (this.parentError) {
            this.logger.error("Parent error:", this.parentError);
        }
        this.logger.trace();
        return this;
    }
