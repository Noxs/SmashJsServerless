...
class SmashError extends Error {
	...
	printError() {
		this.logger.error("Code: " + this.code + ", reason: " + this.getMessageToPrint(), this.details ? "Details: " + this.getDetails(this.details) : "", this.parentError ? "Parent error: " + this.parentError : "");
		return this;
	}
