...
function UpdateManager() {
    ...
    that.install = function (deps, dir) {
        return new Promise(function (resolve, reject) {
            that.launchNpm("install", deps.join(" "), ["--save"], dir).then(function () {
                resolve();
            }, function (error) {
    ...
    that.selfUpdate = function () {
        return new Promise(function (resolve, reject) {
            that.launchNpm("install", "smash-js-serverless@latest", ["-g"]).then(function () {
                resolve();
            }, function (error) {
                console.log("Failed to install smash-js-serveless.", error);
                reject(error);
