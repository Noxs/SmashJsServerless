...
class Event extends smash.Console {
    constructor(rawEvent, context, terminate) {
        ...
        if (typeof terminate !== 'object') {
            throw new Error("Third parameter of Event() must be a string, " + this.typeOf(terminate) + " given");
        }
        if (typeof terminate.terminate !== 'function') {
            throw new Error("Third parameter of Event() must be an object with a function called terminate, " + this.typeOf(terminate.terminate) + " given");
        }
