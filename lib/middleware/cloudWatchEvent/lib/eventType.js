...
class EventType extends smash.Console {
    constructor(route, callback) {
        ...
        if (typeof route !== 'object') {
            throw new Error("First parameter of EventType() must be an object, " + this.typeOf(route));
        }
        if (typeof route.source !== 'string') {
            throw new Error("First parameter of EventType() must have a string property called source, " + this.typeOf(route.source));
        }
        this._source = route.source;
        if (typeof route.version !== 'string') {
            throw new Error("First parameter of EventType() must have a string property called version, " + this.typeOf(route.version));
        }
