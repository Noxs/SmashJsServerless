...
class Response extends smash.Console {
    ...
    cleanOk(body, optionalParameters = {}) {
        ...
        return this.ok(Object.assign(body.map(property => smash.binder.clean(this._request.route.action, property)), optionalParameters));
    }
    ...
    cleanCreated(body, optionalParameters = {}) {
        ...
        return this.created(Object.assign(body.map(property => smash.binder.clean(this._request.route.action, property)), optionalParameters));
    }
    ...
    handleError(error) {
        if (!error || error.constructor !== Error) {
            ...
            if (error.statusCode && this._errorResponse[error.statusCode]) {
                this._errorResponse[error.statusCode].apply(this, [error.message]);
            } else {
                this.internalServerError("Internal server error");
            }
        }
