...
class ApiGatewayProxy extends Next {
    ...
    handleRequest(request, response) {
        ...
        if (smash.binder.requiredRuleExist(request.route.action) === true) {
            ...
            if (bodyIsValid !== true) {
                this.info("Invalid body: ", bodyIsValid);
    ...
    get(route, callback) {
        try {
            ...
            this.error("Failed to register GET route", route, error);
            response.internalServerError("Internal server error");
        }
        return this;
    }
    ...
    post(route, callback) {
        try {
            ...
            this.error("Failed to register POST route", route, error);
            response.internalServerError("Internal server error");
        }
        return this;
    }
    ...
    put(route, callback) {
        try {
            ...
            this.error("Failed to register PUT route", route, error);
            response.internalServerError("Internal server error");
        }
        return this;
    }
    ...
    delete(route, callback) {
        try {
            ...
            this.error("Failed to register DELETE route", route, error);
            response.internalServerError("Internal server error");
        }
        return this;
    }
    ...
    patch(route, callback) {
        try {
            ...
            this.error("Failed to register PATCH route", route, error);
            response.internalServerError("Internal server error");
        }
        return this;
    }
    ...
    options(route, callback) {
        try {
            ...
            this.error("Failed to register OPTIONS route", route, error);
            response.internalServerError("Internal server error");
        }
        return this;
    }
    ...
    head(route, callback) {
        try {
            ...
            this.error("Failed to register HEAD route", route, error);
            response.internalServerError("Internal server error");
        }
        return this;
    }
