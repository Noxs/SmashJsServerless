...
class ApiGatewayProxy extends Next {
    ...
    handleRequest(request, response) {
        ...
        this.info("Matched route: " + request.route.method + " " + request.route.path + "; version: " + request.route.version + "; authorizations: " + (request.route.authorizations ? request.route.authorizations.join(" || ") : "None") + "; request: " + request.path + " in env: " + this.smash.getEnv("ENV") + " with user: " + (request.user ? request.user.username : "Anonymous"));
