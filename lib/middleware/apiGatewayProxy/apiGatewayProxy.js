...
class ApiGatewayProxy extends Next {
    ...
    _registerUserRepository() {
        if (this.smash.config.get("user_repository.file")) {
            const file = this.smash.config.get("user_repository.file");
            ...
            const database = this.smash.config.get("user_repository.database");
            try {
    ...
    handleEvent(event, context, callback) {
        if (typeof callback !== 'function') {
            throw new Error("Thrid parameter of handleEvent() must be a function, " + this.typeOf(callback) + " given");
        }
